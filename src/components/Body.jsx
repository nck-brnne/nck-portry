      ...
      <div className="max-w-7xl mx-auto flex flex-col py-20 lg:pt-24">
        ...
        <div className="flex flex-col items-center md:items-start">
         ...
         <h2 className="mt-5 mb-5 text-neutral-300 text-xl text-center md:text-left">
              Hi, I'm <span className="font-bold italic text-purple-500 ml-1">NICK BRIENNE</span>.
        </h2>
          ...
          <div class="grid grid-cols-1 xl:grid-cols-2 h-fit justify-center items-center lg:justify-start gap-5">
             ...
             <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center text-center mt-6">
                  <a target="_self" 
                      ...
                      text-xs sm:text-sm font-light text-gray-300 bg-neutral-600 
                      px-6 sm:px-10 lg:px-12 py-2 sm:py-2.5 rounded-md sm:rounded-lg border border-neutral-200 hover:text-purple-300 hover:bg-purple-200/20
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" 
                          ...
                          className="absolute right-4 opacity-0 group-hover:opacity-100 transition-all duration-300 ease-in-out">
                          text-orange-700 opacity-0 group-hover:opacity-100"
